...
-- Last modification date: 2022-10-16 19:00:40.797
...
CREATE TABLE Dim_Category (
    ...
    CONSTRAINT Dim_Category_pk PRIMARY KEY  (id)
);
...
-- foreign keys
-- Reference: Dim_Category_Dim_Fruit (table: Dim_Category)
ALTER TABLE Dim_Category ADD CONSTRAINT Dim_Category_Dim_Fruit
